...
| fastmemory | ATF parser and inline Louvain clustering, vendored verbatim from rev a7dec441 in `crates/mahabodi-core/src/fastmemory/` (and the algorithm ported in `louvain.rs`); example inputs in `crates/mahabodi-core/tests/fixtures` | MIT (see `crates/mahabodi-core/tests/fixtures/FASTMEMORY_LICENSE`) | https://github.com/fastBuilderAI/memory |
